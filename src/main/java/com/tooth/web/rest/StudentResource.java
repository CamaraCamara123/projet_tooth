...
import com.tooth.service.StudentService;
...
/**
 * REST controller for managing {@link com.tooth.domain.Student}.
 */
@RestController
...
public class StudentResource {
     ...
     */
    @GetMapping("")
    public List<StudentDTO> getAllStudents(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
