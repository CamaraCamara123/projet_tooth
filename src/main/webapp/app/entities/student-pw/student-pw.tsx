          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('angleLeft')}>
                  <Translate contentKey="toothApp.studentPW.angleLeft">Angle Left</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('angleLeft')} />
                </th>
                <th className="hand" onClick={sort('angleRigth')}>
                  <Translate contentKey="toothApp.studentPW.angleRigth">Angle Rigth</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('angleRigth')} />
                </th>
                <th className="hand" onClick={sort('angleCenter')}>
                  <Translate contentKey="toothApp.studentPW.angleCenter">Angle Center</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('angleCenter')} />
                </th>
            ...
            <tbody>
              {studentPWList.map((studentPW, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{studentPW.angleLeft}</td>
                  <td>{studentPW.angleRigth}</td>
                  <td>{studentPW.angleCenter}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (location.href = `/student-pw/${studentPW.id}/delete`)}
                        color="danger"
                        size="sm"
