  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          groupe: studentEntity?.groupe?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="toothApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            <Translate contentKey="toothApp.student.home.createOrEditLabel">Create or edit a Student</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('toothApp.student.number')}
                id="student-number"
                name="number"
                data-cy="number"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('toothApp.student.cne')}
                id="student-cne"
                name="cne"
                data-cy="cne"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('toothApp.student.cin')}
                id="student-cin"
                name="cin"
                data-cy="cin"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('toothApp.student.birthDay')}
                id="student-birthDay"
                name="birthDay"
                data-cy="birthDay"
                type="datetime-local"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('toothApp.student.user')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField id="student-groupe" name="groupe" data-cy="groupe" label={translate('toothApp.student.groupe')} type="select">
                <option value="" key="0" />
                {groupes
